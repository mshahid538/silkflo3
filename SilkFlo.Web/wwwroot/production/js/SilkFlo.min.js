...
height: 527px;">
      ...
      </div>`;$(n).appendTo("body");$("#SilkfloModal").modal("show")}function showSubmitIdeaModal(){let n=`
...
<br/>
  ...
  <p class="silkflo-modal-content-width" style="margin-top: 16px; margin-bottom: 10px;"> Get started by submitting an idea for a process you’d like automated or enhanced!</p>
      ...
      </div>`;$(n).appendTo("body");$("#submitIdeaModal").modal("show")}function showExplore(){var i,n,t;$("#SilkfloModal").modal("hide");i=`
