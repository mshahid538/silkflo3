...
SilkFlo.Models.Shared.IdeaAuthorisation = {
    /* GetModelFromParentById() Overview
     * ---------------------------------
     * This function will return a model of the Shared.IdeaAuthorisation
     ...
     * fieldNamePrefix - This is defaulted to 'Shared.IdeaAuthorisation.',
     *                   but can be overridden.
     *                   All fields assigned to the model must have its name attribute prefixed.
     *   For example:
     *      Shared.IdeaAuthorisation.Id
     *      Shared.IdeaAuthorisation.Name
     *
    ...
    GetModelFromParentById: function (parentElementId,
                                      names = [
                                         ...
                                         fieldNamePrefix = 'Shared.IdeaAuthorisation.')
    {
        const logPrefix = 'SilkFlo.Models.Shared.IdeaAuthorisation.GetModelFromParentById: ';
    ...
    GetModelFromParent: function (parentElement,
                                  ...
                                  logErrors)
    {
        const logPrefix = 'SilkFlo.Models.Shared.IdeaAuthorisation.GetModelFromParent: ';
     ...
     * modelName         - The name of the element containing the models field elements. Default = 'Shared.IdeaAuthorisation'.
     ...
     *                     Default = 'Shared.IdeaAuthorisation.'
     *                     Example: Shared.IdeaAuthorisation.Id.
     *
     *
     * Return Value
     * ------------
     * A collection of the Shared.IdeaAuthorisation.
     */
    GetModelCollectionFromParentById: function (parentElementId,
                                                modelName = 'Shared.IdeaAuthorisation',
                                                names = [
                                                          'Id',
                                                          'Description',
                                                          'Name',
                                                ...
                                                fieldNamePrefix = 'Shared.IdeaAuthorisation.')
    {
        const logPrefix = 'SilkFlo.Models.Shared.IdeaAuthorisation.GetModelCollectionFromParentById: ';
    ...
    GetModelCollectionFromParent: function (parentElement,
                                            ...
                                            fieldNamePrefix = 'Shared.IdeaAuthorisation.')
    {
        const logPrefix = 'SilkFlo.Models.Shared.IdeaAuthorisation.GetModelCollectionFromParent: ';
     ...
     * Parameters
     * ----------
     * model                - The Shared/IdeaAuthorisation model.
     ...
     * -------------------
     * [HttpPost("/api/Models/Shared/IdeaAuthorisation/Post")]
     * public async Task<IActionResult> Post([FromBody] Models.Shared.IdeaAuthorisation model)
     * {
     *     // Stay awesome!
     * }
     */
    Save: function (
        ...
        url = '/api/Shared/IdeaAuthorisation/Post',
        verb = SilkFlo.Models.Abstract.Verb.POST)
    {
        const logPrefix = 'SilkFlo.Models.Shared.IdeaAuthorisation.Save: ';
     ...
     * Example Server C# Method
     * -------------------
     * [HttpDelete("/api/Models/Shared/IdeaAuthorisation/Delete/Id/{id}")]
    ...
    Delete: function (
        ...
        callbackStatusOther,
        id,
        name = 'Idea Authorisation',
        additionalMessage = '',
        url = '/api/Models/Shared/IdeaAuthorisation/Delete/Id/',
        parentId)
    {
        const logPrefix = 'SilkFlo.Models.Shared.IdeaAuthorisation.Delete: ';
