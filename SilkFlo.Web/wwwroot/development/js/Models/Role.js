...
SilkFlo.Models.Role = {
     ...
     * ---------------------------------
     * This function will return a model of the Role
     ...
     * fieldNamePrefix - This is defaulted to 'Role.',
    ...
    {
        const logPrefix = 'SilkFlo.Models.Role.GetModelFromParentById: ';
    ...
    GetModelFromParent: function (parentElement,
                                  ...
                                  logErrors)
    {
        const logPrefix = 'SilkFlo.Models.Role.GetModelFromParent: ';
     ...
     * modelName         - The name of the element containing the models field elements. Default = 'Role'.
    ...
    GetModelCollectionFromParentById: function (parentElementId,
                                                ...
                                                fieldNamePrefix = 'Role.')
    {
        const logPrefix = 'SilkFlo.Models.Role.GetModelCollectionFromParentById: ';
    ...
    GetModelCollectionFromParent: function (parentElement,
                                            ...
                                            fieldNamePrefix = 'Role.')
    {
        const logPrefix = 'SilkFlo.Models.Role.GetModelCollectionFromParent: ';
     ...
     * -------------------
     * [HttpPost("/api/Models/Role/Post")]
     * public async Task<IActionResult> Post([FromBody] Models.Role model)
     * {
     *     // Stay awesome!
     * }
     */
    ...
    {
        const logPrefix = 'SilkFlo.Models.Role.Save: ';
     ...
     * Example Server C# Method
     * -------------------
     * [HttpDelete("/api/Models/Role/Delete/Id/{id}")]
    ...
    Delete: function (
        ...
        name = 'Role',
        additionalMessage = '',
        url = '/api/Models/Role/Delete/Id/',
        parentId)
    {
        const logPrefix = 'SilkFlo.Models.Role.Delete: ';
