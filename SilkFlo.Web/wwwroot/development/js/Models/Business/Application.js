...
SilkFlo.Models.Business.Application = {
    /* GetModelFromParentById() Overview
     * ---------------------------------
     * This function will return a model of the Business.Application
     ...
     * fieldNamePrefix - This is defaulted to 'Business.Application.',
    ...
    GetModelFromParentById: function (parentElementId,
                                      names = [
                                         ...
                                         fieldNamePrefix = 'Business.Application.')
    {
        const logPrefix = 'SilkFlo.Models.Business.Application.GetModelFromParentById: ';
    ...
    GetModelFromParent: function (parentElement,
                                  ...
                                  logErrors)
    {
        const logPrefix = 'SilkFlo.Models.Business.Application.GetModelFromParent: ';
     ...
     * modelName         - The name of the element containing the models field elements. Default = 'Business.Application'.
     ...
     *                     Example: Business.Application.Id.
     *
     *
     * Return Value
     * ------------
     * A collection of the Business.Application.
     */
    GetModelCollectionFromParentById: function (parentElementId,
                                                modelName = 'Business.Application',
                                                names = [
                                                          'Id',
                                                          'ClientId',
                                                          'Name',
                                                ...
                                                fieldNamePrefix = 'Business.Application.')
    {
        const logPrefix = 'SilkFlo.Models.Business.Application.GetModelCollectionFromParentById: ';
    ...
    GetModelCollectionFromParent: function (parentElement,
                                            ...
                                            fieldNamePrefix = 'Business.Application.')
    {
        const logPrefix = 'SilkFlo.Models.Business.Application.GetModelCollectionFromParent: ';
     ...
     * Parameters
     * ----------
     * model                - The Business/Application model.
     ...
     * -------------------
     * [HttpPost("/api/Models/Business/Application/Post")]
     * public async Task<IActionResult> Post([FromBody] Models.Business.Application model)
     * {
     *     // Stay awesome!
     * }
     */
    Save: function (
        ...
        url = '/api/Business/Application/Post',
        verb = SilkFlo.Models.Abstract.Verb.POST)
    {
        const logPrefix = 'SilkFlo.Models.Business.Application.Save: ';
     ...
     * Example Server C# Method
     * -------------------
     * [HttpDelete("/api/Models/Business/Application/Delete/Id/{id}")]
    ...
    Delete: function (
        ...
        name = 'Application',
        additionalMessage = '',
        url = '/api/Models/Business/Application/Delete/Id/',
        parentId)
    {
        const logPrefix = 'SilkFlo.Models.Business.Application.Delete: ';
