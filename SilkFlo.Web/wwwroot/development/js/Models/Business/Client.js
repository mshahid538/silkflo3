...
SilkFlo.Models.Business.Client = {
    /* GetModelFromParentById() Overview
     * ---------------------------------
     * This function will return a model of the Business.Client
     ...
     * fieldNamePrefix - This is defaulted to 'Business.Client.',
    ...
    GetModelFromParentById: function (parentElementId,
                                      names = [
                                         ...
                                         fieldNamePrefix = 'Business.Client.')
    {
        const logPrefix = 'SilkFlo.Models.Business.Client.GetModelFromParentById: ';
    ...
    GetModelFromParent: function (parentElement,
                                  ...
                                  logErrors = true)
    {
        const logPrefix = 'SilkFlo.Models.Business.Client.GetModelFromParent: ';
     ...
     * modelName         - The name of the element containing the models field elements. Default = 'Business.Client'.
     ...
     *                     Example: Business.Client.Id.
     *
     *
     * Return Value
     * ------------
     * A collection of the Business.Client.
     */
    GetModelCollectionFromParentById: function (parentElementId,
                                                modelName = 'Business.Client',
                                                names = [
                                                          'Id',
                                                          'AccountOwnerId',
                                                          'Address1',
                                                ...
                                                fieldNamePrefix = 'Business.Client.')
    {
        const logPrefix = 'SilkFlo.Models.Business.Client.GetModelCollectionFromParentById: ';
    ...
    GetModelCollectionFromParent: function (parentElement,
                                            ...
                                            fieldNamePrefix = 'Business.Client.')
    {
        const logPrefix = 'SilkFlo.Models.Business.Client.GetModelCollectionFromParent: ';
     ...
     * Parameters
     * ----------
     * model                - The Business/Client model.
     ...
     * -------------------
     * [HttpPost("/api/Models/Business/Client/Post")]
     * public async Task<IActionResult> Post([FromBody] Models.Business.Client model)
     * {
     *     // Stay awesome!
     * }
     */
    ...
    Save: function (
        ...
        url = '/api/Business/Client/Post',
        verb = SilkFlo.Models.Abstract.Verb.POST)
    {
        if (!model)
        {
            const logPrefix = 'SilkFlo.Models.Business.Client.Save: ';
    ...
    Delete: function (
        ...
        name = 'Client',
        additionalMessage = '',
        url = '/api/Models/Business/Client/Delete/Id/',
        parentId)
    {
        const logPrefix = 'SilkFlo.Models.Business.Client.Delete: ';
