...
{
    public partial class Follow : Abstract
    {
        private SilkFlo.Data.Core.Domain.Business.Follow _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Follow ()
        {
            _core = new SilkFlo.Data.Core.Domain.Business.Follow();
        }
        public Follow(SilkFlo.Data.Core.Domain.Business.Follow core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Business.Follow cannot be null");
        }
        #endregion

        #region Properties
        public string DisplayText { get; set; }
        public SilkFlo.Data.Core.Domain.Business.Follow GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Business.Follow core)
        {
            _core = core;
        }
        ...
        public static List<Models.Business.Follow> Create(IEnumerable<Data.Core.Domain.Business.Follow> cores)
        {
            return cores.Select(core => new Models.Business.Follow(core)).ToList();
        }
        
        public static Models.Business.Follow[] Create(Data.Core.Domain.Business.Follow[] cores)
        {
            return cores.Select(core => new Models.Business.Follow(core)).ToArray();
        }
    }
}