...
* GetComment()
  Two overrides to get the parent comment for the object.
...
{
    public partial class Recipient : Abstract
    {
        private SilkFlo.Data.Core.Domain.Business.Recipient _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Recipient ()
        {
            _core = new SilkFlo.Data.Core.Domain.Business.Recipient();
        }
        public Recipient(SilkFlo.Data.Core.Domain.Business.Recipient core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Business.Recipient cannot be null");
        }
        #endregion

        #region Properties
        public string DisplayText { get; set; }
        public SilkFlo.Data.Core.Domain.Business.Recipient GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Business.Recipient core)
        {
            _core = core;
        }
        ...
        public string CommentId
        {
            ...
            set
            {
                if (_core.CommentId == value)
                    return;

                _core.CommentId = value;
                _comment = null;
            }
        }
        private Models.Business.Comment _comment;
        public Models.Business.Comment Comment
        {
            get
            {
                if (_comment != null)
                ...
                if (_core.Comment != null)
                    _comment = new Models.Business.Comment(_core.Comment);
            ...
            set
            {
                ...
                {
                    if (_core.CommentId != _comment.Id)
                        _core.Comment = _comment.GetCore();

                    _core.CommentId = _comment.Id;
                }
            }
        }
        ...
        public string CommentId_ErrorMessage { get; set; } = "Required";
        public bool CommentId_IsInValid { get; set; }
        ...
        {
            get => _comments ??= new List<Models.Business.Comment>();
            set => _comments = value;
        }
        ...
        public static List<Models.Business.Recipient> Create(IEnumerable<Data.Core.Domain.Business.Recipient> cores)
        {
            return cores.Select(core => new Models.Business.Recipient(core)).ToList();
        }
        
        public static Models.Business.Recipient[] Create(Data.Core.Domain.Business.Recipient[] cores)
        {
            return cores.Select(core => new Models.Business.Recipient(core)).ToArray();
        }
    }
}