...
{
    public partial class Country : Abstract
    {
        private SilkFlo.Data.Core.Domain.Shared.Country _core;
        #region Constructors
        
        // This constructor is used by HTTP posts 
        public Country ()
        {
            _core = new SilkFlo.Data.Core.Domain.Shared.Country();
        }
        public Country(SilkFlo.Data.Core.Domain.Shared.Country core)
        {
            _core = core ??   
	        throw new NullReferenceException("The SilkFlo.Data.Core.Domain.Shared.Country cannot be null");
        }
        #endregion
        ...
        public SilkFlo.Data.Core.Domain.Shared.Country GetCore()
        {
            return _core;
        }
        public void SetCore(SilkFlo.Data.Core.Domain.Shared.Country core)
        {
            _core = core;
        }
        ...
        public static List<Models.Shared.Country> Create(IEnumerable<Data.Core.Domain.Shared.Country> cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            if(includeEmpty)
            {
                ...
                models.Add(new Models.Shared.Country
                {
                    DisplayText = "<Empty>"
                });

                models.AddRange(cores.Select(core => new Models.Shared.Country(core)));
                return models;
            }

            return cores.Select(core => new Models.Shared.Country(core)).ToList();
        }

        public static Models.Shared.Country[] Create(Data.Core.Domain.Shared.Country[] cores, bool includeEmpty = false)
        {
            if (cores == null)
                return null;
            ...
            return cores.Select(core => new Models.Shared.Country(core)).ToArray();
        }
    }
}