...
namespace SilkFlo.Data.Persistence.Repositories.Business
{
  public class ClientRepository : IClientRepository
  {
    ...
    public void GetClientFor(IEnumerable<Application> applications) => this.GetClientForAsync(applications).RunSynchronously();

    public async Task GetClientForAsync(IEnumerable<Application> applications)
    {
    ...
    public void GetClientFor(Application application) => this.GetClientForAsync(application).RunSynchronously();

    public async Task GetClientForAsync(Application application)
    {
      if (application == null)
        ;
      else
