...
namespace SilkFlo.Data.Persistence.Repositories.Business
{
  public class VersionRepository : IVersionRepository
  {
    ...
    public void GetForApplication(Application application) => this.GetForApplicationAsync(application).RunSynchronously();

    public async Task GetForApplicationAsync(Application application)
    {
    ...
    public void GetForApplication(IEnumerable<Application> applications) => this.GetForApplicationAsync(applications).RunSynchronously();

    public async Task GetForApplicationAsync(IEnumerable<Application> applications)
    {
