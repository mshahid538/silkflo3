...
// Type: SilkFlo.Data.Core.Domain.Business.Location
...
namespace SilkFlo.Data.Core.Domain.Business
{
  ...
  public class Location : Abstract
  {
    private string _id = "";
    ...
    public Location() => this._createdDate = new System.DateTime?(System.DateTime.Now);
