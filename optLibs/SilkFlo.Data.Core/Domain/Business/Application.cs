...
// Type: SilkFlo.Data.Core.Domain.Business.Application
...
namespace SilkFlo.Data.Core.Domain.Business
{
  ...
  public class Application : Abstract
  {
    private string _id = "";
    ...
    public Application() => this._createdDate = new System.DateTime?(System.DateTime.Now);
