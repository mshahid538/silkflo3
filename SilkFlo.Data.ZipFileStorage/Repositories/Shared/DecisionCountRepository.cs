...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class DecisionCountRepository : IDecisionCountRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<DecisionCount>) (await dataSetAsync.SharedDecisionCounts.ToListAsync<DecisionCount>()).OrderByDescending<DecisionCount, Decimal>((Func<DecisionCount, Decimal>) (m => m.Weighting)).ThenBy<DecisionCount, string>((Func<DecisionCount, string>) (m => m.Name));
    }
