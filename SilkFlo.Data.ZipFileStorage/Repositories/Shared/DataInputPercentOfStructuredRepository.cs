...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class DataInputPercentOfStructuredRepository : IDataInputPercentOfStructuredRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<DataInputPercentOfStructured>) (await dataSetAsync.SharedDataInputPercentOfStructureds.ToListAsync<DataInputPercentOfStructured>()).OrderByDescending<DataInputPercentOfStructured, Decimal>((Func<DataInputPercentOfStructured, Decimal>) (m => m.Weighting)).ThenBy<DataInputPercentOfStructured, string>((Func<DataInputPercentOfStructured, string>) (m => m.Name));
    }
