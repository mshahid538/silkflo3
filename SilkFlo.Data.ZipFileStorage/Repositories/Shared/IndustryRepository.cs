...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class IndustryRepository : IIndustryRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Industry>) (await dataSetAsync.SharedIndustries.ToListAsync<Industry>()).OrderBy<Industry, int>((Func<Industry, int>) (m => m.Sort)).ThenBy<Industry, string>((Func<Industry, string>) (m => m.Name));
    }
