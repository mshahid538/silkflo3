...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class AchievementRepository : IAchievementRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Achievement>) (await dataSetAsync.SharedAchievements.ToListAsync<Achievement>()).OrderBy<Achievement, int>((Func<Achievement, int>) (m => m.Sort)).ThenBy<Achievement, string>((Func<Achievement, string>) (m => m.Name));
    }
