...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class SubmissionPathRepository : ISubmissionPathRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<SubmissionPath>) (await dataSetAsync.SharedSubmissionPaths.ToListAsync<SubmissionPath>()).OrderBy<SubmissionPath, string>((Func<SubmissionPath, string>) (m => m.Name));
    }
