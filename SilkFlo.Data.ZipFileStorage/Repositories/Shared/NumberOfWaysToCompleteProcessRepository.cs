...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class NumberOfWaysToCompleteProcessRepository : INumberOfWaysToCompleteProcessRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<NumberOfWaysToCompleteProcess>) (await dataSetAsync.SharedNumberOfWaysToCompleteProcesses.ToListAsync<NumberOfWaysToCompleteProcess>()).OrderByDescending<NumberOfWaysToCompleteProcess, Decimal>((Func<NumberOfWaysToCompleteProcess, Decimal>) (m => m.Weighting)).ThenBy<NumberOfWaysToCompleteProcess, string>((Func<NumberOfWaysToCompleteProcess, string>) (m => m.Name));
    }
