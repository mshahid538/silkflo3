...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class CountryRepository : ICountryRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Country>) (await dataSetAsync.SharedCountries.ToListAsync<Country>()).OrderBy<Country, int>((Func<Country, int>) (m => m.Sort)).ThenBy<Country, string>((Func<Country, string>) (m => m.Name));
    }
