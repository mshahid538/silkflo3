...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class PeriodRepository : IPeriodRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Period>) (await dataSetAsync.SharedPeriods.ToListAsync<Period>()).OrderBy<Period, int>((Func<Period, int>) (m => m.Sort)).ThenBy<Period, string>((Func<Period, string>) (m => m.Name));
    }
