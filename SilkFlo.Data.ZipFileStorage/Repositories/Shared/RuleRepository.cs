...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class RuleRepository : IRuleRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Rule>) (await dataSetAsync.SharedRules.ToListAsync<Rule>()).OrderByDescending<Rule, Decimal>((Func<Rule, Decimal>) (m => m.Weighting)).ThenBy<Rule, string>((Func<Rule, string>) (m => m.Name));
    }
