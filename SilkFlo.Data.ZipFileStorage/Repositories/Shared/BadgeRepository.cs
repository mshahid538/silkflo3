...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class BadgeRepository : IBadgeRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Badge>) (await dataSetAsync.SharedBadges.ToListAsync<Badge>()).OrderBy<Badge, int>((Func<Badge, int>) (m => m.Sort)).ThenBy<Badge, string>((Func<Badge, string>) (m => m.Name));
    }
