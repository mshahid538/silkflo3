...
namespace SilkFlo.Data.Persistence.Repositories.Shared
{
  public class StageRepository : IStageRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Stage>) (await dataSetAsync.SharedStages.ToListAsync<Stage>()).OrderBy<Stage, int>((Func<Stage, int>) (m => m.Sort)).ThenBy<Stage, string>((Func<Stage, string>) (m => m.Name));
    }
