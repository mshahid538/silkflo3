...
namespace SilkFlo.Data.Persistence.Repositories.Shop
{
  public class PriceRepository : IPriceRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Price>) (await dataSetAsync.ShopPrices.ToListAsync<Price>()).OrderBy<Price, string>((Func<Price, string>) (m => m.PeriodId)).ThenBy<Price, string>((Func<Price, string>) (m => m.ProductId));
    }
