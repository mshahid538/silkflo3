...
namespace SilkFlo.Data.Persistence.Repositories.Shop
{
  public class ProductRepository : IProductRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Product>) (await dataSetAsync.ShopProducts.ToListAsync<Product>()).OrderBy<Product, int>((Func<Product, int>) (m => m.Sort)).ThenBy<Product, string>((Func<Product, string>) (m => m.Name));
    }
