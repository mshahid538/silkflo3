...
namespace SilkFlo.Data.Persistence.Repositories.Shop
{
  public class SubscriptionRepository : ISubscriptionRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Subscription>) (await dataSetAsync.ShopSubscriptions.ToListAsync<Subscription>()).OrderBy<Subscription, DateTime>((Func<Subscription, DateTime>) (m => m.DateStart));
    }
