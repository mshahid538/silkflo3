...
namespace SilkFlo.Data.Persistence.Repositories
{
  public class RoleRepository : IRoleRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Role>) (await dataSetAsync.Roles.ToListAsync<Role>()).OrderByDescending<Role, int>((Func<Role, int>) (m => m.Sort)).ThenBy<Role, string>((Func<Role, string>) (m => m.Name));
    }
