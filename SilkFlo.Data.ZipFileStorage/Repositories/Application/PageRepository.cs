...
namespace SilkFlo.Data.Persistence.Repositories.Application
{
  public class PageRepository : IPageRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Page>) (await dataSetAsync.ApplicationPages.ToListAsync<Page>()).OrderBy<Page, int>((Func<Page, int>) (m => m.Sort)).ThenBy<Page, string>((Func<Page, string>) (m => m.Name));
    }
