...
namespace SilkFlo.Data.Persistence.Repositories
{
  public class AnalyticRepository : IAnalyticRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Analytic>) (await dataSetAsync.Analytics.ToListAsync<Analytic>()).OrderBy<Analytic, DateTime>((Func<Analytic, DateTime>) (m => m.Date)).ThenBy<Analytic, string>((Func<Analytic, string>) (m => m.UserId));
    }
