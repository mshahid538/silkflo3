...
namespace SilkFlo.Data.Persistence.Repositories
{
  public class UserRepository : IUserRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<User>) (await dataSetAsync.Users.ToListAsync<User>()).OrderBy<User, string>((Func<User, string>) (m => m.FirstName)).ThenBy<User, string>((Func<User, string>) (m => m.LastName));
    }
