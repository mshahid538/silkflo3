...
namespace SilkFlo.Data.Persistence.Repositories.Business
{
    public class IdeaApplicationVersionRepository : IIdeaApplicationVersionRepository
    {
        ...
        {
            DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
            return (IEnumerable<IdeaApplicationVersion>)dataSetAsync.BusinessIdeaApplicationVersions.ToList<IdeaApplicationVersion>();
        }
        ...
        public async Task<IEnumerable<IdeaApplicationVersion>> FindAsync(Func<IdeaApplicationVersion, bool> predicate)
        {
            DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
