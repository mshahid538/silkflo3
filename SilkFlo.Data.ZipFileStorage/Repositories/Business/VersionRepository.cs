...
namespace SilkFlo.Data.Persistence.Repositories.Business
{
    public class VersionRepository : IVersionRepository
    {
        ...
        {
            DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
            return (IEnumerable<SilkFlo.Data.Core.Domain.Business.Version>) (await dataSetAsync.BusinessVersions.ToListAsync<SilkFlo.Data.Core.Domain.Business.Version>()).OrderByDescending<SilkFlo.Data.Core.Domain.Business.Version, string>((Func<SilkFlo.Data.Core.Domain.Business.Version, string>)(m => m.Name)).ThenByDescending<SilkFlo.Data.Core.Domain.Business.Version, string>((Func<SilkFlo.Data.Core.Domain.Business.Version, string>)(m => m.ApplicationId));
        }
        ...
        public void GetForApplication(Core.Domain.Business.Application application) => this.GetForApplicationAsync(application).RunSynchronously();

        public async Task GetForApplicationAsync(Core.Domain.Business.Application application)
        {
        ...
        public void GetForApplication(IEnumerable<Core.Domain.Business.Application> applications) => this.GetForApplicationAsync(applications).RunSynchronously();

        public async Task GetForApplicationAsync(IEnumerable<Core.Domain.Business.Application> applications)
        {
            if (applications == null)
                return;
            foreach (Core.Domain.Business.Application application in applications)
