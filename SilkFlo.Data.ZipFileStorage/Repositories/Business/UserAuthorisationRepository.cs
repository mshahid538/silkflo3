...
namespace SilkFlo.Data.Persistence.Repositories.Business
{
  public class UserAuthorisationRepository : IUserAuthorisationRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<UserAuthorisation>) (await dataSetAsync.BusinessUserAuthorisations.ToListAsync<UserAuthorisation>()).OrderBy<UserAuthorisation, string>((Func<UserAuthorisation, string>) (m => m.UserId)).ThenBy<UserAuthorisation, string>((Func<UserAuthorisation, string>) (m => m.IdeaId)).ThenBy<UserAuthorisation, string>((Func<UserAuthorisation, string>) (m => m.IdeaAuthorisationId));
    }
