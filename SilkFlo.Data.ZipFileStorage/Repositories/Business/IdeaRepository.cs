...
namespace SilkFlo.Data.Persistence.Repositories.Business
{
  public class IdeaRepository : IIdeaRepository
  {
    ...
    {
      DataSet dataSetAsync = await UnitOfWork.GetDataSetAsync();
      return (IEnumerable<Idea>) (await dataSetAsync.BusinessIdeas.ToListAsync<Idea>()).OrderBy<Idea, string>((Func<Idea, string>) (m => m.Name)).ThenBy<Idea, string>((Func<Idea, string>) (m => m.SubTitle)).ThenBy<Idea, string>((Func<Idea, string>) (m => m.Summary));
    }
