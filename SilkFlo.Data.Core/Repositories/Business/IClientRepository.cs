...
// Type: SilkFlo.Data.Core.Repositories.Business.IClientRepository
...
namespace SilkFlo.Data.Core.Repositories.Business
{
  public interface IClientRepository
  {
    ...
    Task GetClientForAsync(Domain.Business.Application application);

    Task GetClientForAsync(IEnumerable<Domain.Business.Application> applications);
